...
// INPUT DATA
/*
// Crys_freq(Hz): 30000000    Crys_tol(ppm): 150    IF_mode: 2    High_perf_Ch_Fil: 1    OSRtune: 0    Ch_Fil_Bw_AFC: 0    ANT_DIV: 0    PM_pattern: 0    
// MOD_type: 2    Rsymb(sps): 19200    Fdev(Hz): 55000    RXBW(Hz): 150000    Manchester: 0    AFC_en: 0    Rsymb_error: 0.0    Chip-Version: 2    
// RF Freq.(MHz): 433.15    API_TC: 29    fhst: 150000    inputBW: 0    BERT: 0    RAW_dout: 0    D_source: 0    Hi_pfm_div: 1    
// 
// # RX IF frequency is  -468750 Hz
// # WB filter 2 (BW = 412.25 kHz);  NB-filter 2 (BW = 412.25 kHz)
// 
// Modulation index: 5.729
*/
...
*/
#define RF_PREAMBLE_TX_LENGTH_9 0x11, 0x10, 0x09, 0x00, 0x08, 0x10, 0x00, 0x0F, 0x31, 0x00, 0x00, 0x00, 0x00
...
*/
#define RF_SYNC_CONFIG_5 0x11, 0x11, 0x05, 0x00, 0x03, 0x54, 0xA5, 0x54, 0xA5
...
*/
#define RF_PKT_LEN_12 0x11, 0x12, 0x0C, 0x08, 0x00, 0x00, 0x00, 0x40, 0x40, 0x00, 0x0E, 0x04, 0x80, 0x00, 0x00, 0x00
...
*/
#define RF_MODEM_MOD_TYPE_12 0x11, 0x20, 0x0C, 0x00, 0x02, 0x00, 0x07, 0x02, 0xEE, 0x00, 0x01, 0xC9, 0xC3, 0x80, 0x00, 0x0F
...
*/
#define RF_MODEM_FREQ_DEV_0_1 0x11, 0x20, 0x01, 0x0C, 0x05
...
*/
#define RF_MODEM_AFC_GEAR_7 0x11, 0x20, 0x07, 0x2C, 0x04, 0x36, 0x80, 0x38, 0x27, 0x51, 0x80
...
*/
#define RF_MODEM_AGC_WINDOW_SIZE_3 0x11, 0x20, 0x03, 0x38, 0x11, 0xAB, 0xAB
...
*/
#define RF_MODEM_OOK_CNT1_9 0x11, 0x20, 0x09, 0x42, 0xA4, 0x02, 0xD6, 0x83, 0x00, 0xC6, 0x01, 0x80, 0xFF
...
*/
#define RF_FREQ_CONTROL_INTE_8 0x11, 0x40, 0x08, 0x00, 0x38, 0x0E, 0x06, 0xD3, 0x28, 0xF6, 0x20, 0xFE
